...
class Update extends AsyncTask<String, String, String>
{
    ...
    protected void onPostExecute(final String s) {
        if (this.a > Utils.v1 || this.b > Utils.v2) {
            ...
            builder.setPositiveButton("Download Now", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ctx.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("http://kp7742.github.io/")));
                }
            });
            ...
            builder2.setTitle("Error!").setMessage("You Not Connect With Internet! Or Any Other Problem");
            builder2.create();
            builder2.show();
        } else {
            AlertDialog.Builder builder3 = new AlertDialog.Builder(ctx);
            builder3.setTitle("Good!").setMessage("You have latest update!:" + " KWhatsApp v" + Utils.v1 + "." + Utils.v2);
